...
export const resumeSchema = z.object({
  ...
  settings: z.object({
    template: z.enum(["ats-classic", "modern", "executive", "two-column", "swiss-grid", "tech-compact", "timeline", "studio"]),
    ...
    showPhoto: z.boolean(), photoShape: z.enum(["circle", "rectangle"]), photoSize: z.enum(["small", "medium", "large"]),
